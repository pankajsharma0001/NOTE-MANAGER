    ...
    <div className="flex min-h-screen bg-gray-900 text-gray-100">
      ...
      <main className="flex-1 p-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition hover:scale-105 transform text-white">
            <h4 className="font-semibold mb-2">License Exam Preparation</h4>
            <p className="text-gray-400 text-sm">Get ready for your NEC license exams with our resources.</p>
          </div>
          <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition hover:scale-105 transform text-center text-white">
            <div className="mb-4">
              <div className="inline-block p-4 bg-gray-700 rounded-lg">
                <span role="img" aria-label="QR code">📱</span>
              </div>
            </div>
            <h4 className="font-semibold mb-2">Grow your network on Discord</h4>
            <p className="text-gray-400 text-sm mb-4">Join our active community to discuss technology, jobs, subject materials, and share resources.</p>
            <button className="px-4 py-2 bg-teal-400 text-gray-900 rounded-lg hover:bg-teal-500 transition">JOIN DISCORD</button>
          </div>
        </section>
      </main>
    </div>
